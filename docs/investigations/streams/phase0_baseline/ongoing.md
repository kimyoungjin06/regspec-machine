...
- must_run:
  - `RUN_ID=phase0_baseline TAG=phase-0 ./modules/03_regspec_machine/scripts/run_module_03.sh paired --exec`
...
- optional:
  - `RUN_ID=phase0_baseline TAG=phase-0 ./modules/03_regspec_machine/scripts/run_module_03.sh overnight --exec`
  - `RUN_ID=phase0_baseline TAG=phase-0 ./modules/03_regspec_machine/scripts/run_module_03.sh ui-journey-smoke --exec`
- source:
  - active lock 기준: `modules/03_regspec_machine/docs/investigations/registry/active_stream_lock.yaml`
